       ...
       <div class="right-aside">
                ...
                <div class="stats-box-jugar">
                    <div class="character-image-container-jugar">
                        <img src="Imagenes/PJs/Nino.png" alt="Goblin Arist√≥teles" class="character-image-jugar">
                    ...
                    <ul class="stats-list-jugar">
                        ...
                        <li><span class="stat-name">Man·:</span> <span class="stat-value">${sessionScope.personajeInfoActual.mana_Actual} / ${sessionScope.personajeInfoActual.mana_Max}</span></li>
