create schema  If not exists ProyectoV1;
use ProyectoV1;
...
CREATE TABLE  If not exists Partida_NPC (
...
CREATE TABLE  If not exists Partida_Enemigos (
...
CREATE TABLE  If not exists Lugares_Enemigos (
...
CREATE TABLE  If not exists Lugares_NPC (
...
CREATE TABLE  If not exists Imagenes_Partida (
...
CREATE TABLE  If not exists Imagenes_NPC (
